...
class CEALSelector:
    ...
    def __init__(self, dataset, lmdb_handle, base_size, batch_size, num_classes, start_entropy_threshold, entropy_change_per_selection, device):
