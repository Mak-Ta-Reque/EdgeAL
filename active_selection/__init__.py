...
def get_active_selector(args, lmdb_handle, train_set):
    if args.active_selection_mode == 'random':
        ...
        return softmax_margin.SoftmaxMarginSelector(args.dataset, lmdb_handle, args.base_size, args.batch_size, args.device)
    elif args.active_selection_mode == 'softmax_confidence':
        return softmax_confidence.SoftmaxConfidenceSelector(args.dataset, lmdb_handle, args.base_size, args.batch_size, device=args.device)
        ...
        return regional_vote_entropy.RegionalVoteEntropySelector(args.dataset, lmdb_handle, args.superpixel_dir, args.base_size, args.batch_size, train_set.num_classes, args.region_size, overlap_handler, mode=args.region_selection_mode, device=args.device)
    elif args.active_selection_mode == 'coreset':
        return core_set.CoreSetSelector(args.dataset, lmdb_handle, args.base_size, args.batch_size, args.device)
    elif args.active_selection_mode == 'voteentropy_max_repr':
        return max_repr.MaxRepresentativeSelector(args.dataset, lmdb_handle, args.base_size, args.batch_size, train_set.num_classes, device=args.device)
