...
def get_colormap(dataset):
    ...
    if dataset.startswith('scannet') or dataset.startswith('suncg') or dataset.startswith('matterport')  or dataset.startswith('scenenet') or dataset.startswith('duke') or dataset.startswith('AROI') or dataset.startswith('UMN') :
