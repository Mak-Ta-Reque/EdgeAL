...
def main():
    ...
    model = get_model(name=args.model, in_channels=in_channels, num_classes=train_set.num_classes,  backbone=args.backbone, output_stride=args.out_stride, sync_bn=args.sync_bn, ratio = args.g_ratio)
    ...
    writer.add_scalar('test/mDice', avg_dice, avg_dice)
